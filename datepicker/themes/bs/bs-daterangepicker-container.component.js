...
var BsDaterangepickerContainerComponent = (function (_super) {
    ...
    function BsDaterangepickerContainerComponent(_config, _store, _actions, _effects) {
        ...
        _this.customDates = _this._config.customDates;
        return _this;
    }
    ...
    BsDaterangepickerContainerComponent.prototype.onCustomDateSelect = function (bsCustomDate) {
        this.daySelectHandler({ isDisabled: false, isOtherMonth: false,
